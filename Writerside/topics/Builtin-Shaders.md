<card-summary>Built-in material shaders provided by kool.</card-summary>
...
<note>
All builtin shaders are written in <a href="KSL.md"/>, the same DSL you can use to write your own custom shaders.
</note>
