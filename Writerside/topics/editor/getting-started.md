...
<link-summary>Get started with the kool Editor locally, or in your browser.</link-summary>
...
clone the [kool templates](%url.kool.templates%) and use the `kool-editor-template` as a starting point.
